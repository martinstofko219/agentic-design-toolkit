...
- [ ] Example code uses the project's sanctioned display mechanism, appears only on examples that teach a pattern worth copying, and snippets are free of Storybook-only wrapper markup
